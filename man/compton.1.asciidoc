...
*-I*, *--fade-in-ms*='MILLISECONDS'::
	Length of a fade-in animation, in milliseconds. (>= 0, defaults to 300)

*-O*, *--fade-out-ms*='MILLISECONDS'::
	Length of a fade-out animation, in milliseconds. (>= 0, defaults to 300)

*-D*, *--animation-delta*='MILLISECONDS'::
	The time between animation steps, in milliseconds. (> 0, defaults to 10)
...
*--inactive-dim-ms*='MILLISECONDS'::
	Length of a dim animation, in milliseconds. (>= 0, defaults to 0)

*--inactive-undim-ms*='MILLISECONDS'::
	Length of an undim animation, in milliseconds. (>= 0, defaults to 0)
